...
public class CalendarListAdapter extends RecyclerView.Adapter<View_Holder> implements
    ...
    int lastPosition = 0;
    private final TreeMap calendarMap;
    private CalendarItemOnClickListener listener;
    private View v;
    private CalendarItemListAdapter resAdapter;


    public CalendarListAdapter(AppCompatActivity activity, LinkedHashMap data, TreeMap calendar) {
    ...
    public void onBindViewHolder(View_Holder holder, int position) {
        ...
        didOnChangeTitle(String.valueOf(hour), position);
...
//            if(givenTime.before(currentTime))holder.iv_background_top.setVisibility(View.VISIBLE);
    ...
    public void didOnChangeTitle(String hours, int position) {
        if (listener != null) listener.didOnChangeTitle(hours, position);
    }
