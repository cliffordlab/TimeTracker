...
public class MenuView extends RelativeLayout implements View.OnClickListener {
    ...
    private ImageView menu_btn_flip, menu_btn_calendar;
    ...
    private void initLayout() {
        ...
        menu_btn_calendar = (ImageView) view.findViewById(R.id.menu_btn_calendar);
...
//		view.setOnClickListener(this);
    ...
    public void showCalendar(){
        menu_btn_calendar.setVisibility(VISIBLE);
    }
